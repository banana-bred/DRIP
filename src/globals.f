...
module globals
  ...
  use types, only: rp, targ_type, elec_chanl_type
  ...
  integer, allocatable :: targ_ndegen(:)
  ...
  type(targ_type),               allocatable :: targ_states(:)
